...
export default function Education() {
  const education = [
    {
      ...
      qualification: "Computer Networking",
      grade: "3.64 / 4.0 CGPA",
      year: "2017 – 2020",
      involvement:
        "Kelab Debat, Persatuan Seni Silat Cekak Hanafi, Jawatankuasa Pengurusan Kolej Cempaaka",
      achievement: "Pendebat 10 Terbaik,Perembahan MEGAH, Pengurusan Program",
    },
    {
      ...
      grade: "3.34 / 4.0 CGPA",
      year: "2015 – 2016",
      involvement: "Unit Pengurusan Surau Asasi",
  ...
  return (
    <section className="container my-5">
      <h2 className="text-primary border-bottom pb-2 mb-4">Education Background</h2>
